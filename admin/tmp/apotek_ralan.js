...
$('.databarang_ajax').selectator({
  ...
  load: function (search, callback) {
    ...
    $.ajax({
      url: 'https://simrsfitricandra.site/admin/dokter_ralan/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=d801e95db389',
      type: 'GET',
      dataType: 'json',
...
function bersih(){
  ...
  $('input:text[name=tgl_perawatan]').val("2026-02-23");
  $('input:text[name=tgl_registrasi]').val("2026-02-23");
