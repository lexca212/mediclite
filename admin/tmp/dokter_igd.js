...
$("#form_soap").on("click", "#simpan_soap", function(event){
    ...
    spo2 : spo2
      ...
      $('input:text[name=jam_rawat]').val("12:18:34");
...
$(document).ready(function () {
  ...
  $('.databarang_ajax').selectator({
    ...
    load: function (search, callback) {
      ...
      $.ajax({
        url: 'https://simrsfitricandra.site/admin/dokter_igd/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=8c97a22ee60a',
        type: 'GET',
        dataType: 'json',
  ...
  $('.master_aturan_pakai').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'https://simrsfitricandra.site/admin/dokter_igd/ajax?show=aturan_pakai&aturan=' + encodeURIComponent(search) + '&t=8c97a22ee60a',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'https://simrsfitricandra.site/admin/dokter_igd/ajax?show=jns_perawatan&nm_perawatan=' + encodeURIComponent(search) + '&t=8c97a22ee60a',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan_lab_ajax').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'https://simrsfitricandra.site/admin/dokter_igd/ajax?show=jns_perawatan_lab&nm_perawatan=' + encodeURIComponent(search) + '&t=8c97a22ee60a',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan_rad_ajax').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'https://simrsfitricandra.site/admin/dokter_igd/ajax?show=jns_perawatan_radiologi&nm_perawatan=' + encodeURIComponent(search) + '&t=8c97a22ee60a',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
