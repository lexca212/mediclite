...
$("#form_soap").on("click", "#simpan_soap", function(event){
    ...
    spo2 : spo2
      ...
      $('input:text[name=tgl_perawatan]').val("2026-04-04");
      $('input:text[name=tgl_registrasi]').val("2026-04-04");
      $('input:text[name=jam_rawat]').val("15:29:22");
...
$(document).ready(function () {
  ...
  $('.databarang_ajax').selectator({
    ...
    load: function (search, callback) {
      ...
      $.ajax({
        url: 'http://localhost/mediclite/admin/dokter_ranap/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=e8a38071b9a1',
        type: 'GET',
        dataType: 'json',
