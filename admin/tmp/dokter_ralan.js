...
$("#form_soap").on("click", "#simpan_soap", function(event){
    ...
    spo2 : spo2
      ...
      $('input:text[name=tgl_perawatan]').val("2026-02-25");
      $('input:text[name=tgl_registrasi]').val("2026-02-25");
      //$('input:text[name=jam_rawat]').val("14:34:40");
...
$(document).ready(function () {
  ...
  $('.databarang_ajax').selectator({
    ...
    load: function (search, callback) {
      ...
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
  ...
  $('.master_aturan_pakai').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=aturan_pakai&aturan=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=jns_perawatan&nm_perawatan=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan_lab_ajax').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=jns_perawatan_lab&nm_perawatan=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.jns_perawatan_rad_ajax').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=jns_perawatan_radiologi&nm_perawatan=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.icd10_').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=icd10&s=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
  ...
  $('.icd9_').selectator({
    ...
    load: function (search, callback) {
      if (search.length < this.minSearchLength) return callback();
      $.ajax({
        url: 'http://192.168.0.212/admin/dokter_ralan/ajax?show=icd9&s=' + encodeURIComponent(search) + '&t=f8e9b8c04c79',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          callback(data.slice(0, 100));
