...
$("#display").on("click", ".sep", function(event){
  ...
  var url = baseURL + '/vclaim/bynokartu/' + no_peserta + '/2026-02-16?t=' + mlite.token;
...
function bersih(){
  ...
  $('input:text[name=tgl_perawatan]').val("2026-02-16");
  $('input:text[name=tgl_registrasi]').val("2026-02-16");
