...
$('.databarang_ajax').selectator({
  ...
  load: function (search, callback) {
    ...
    $.ajax({
      url: 'https://simrsfitricandra.site/admin/dokter_ranap/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=1a6f40118f1f',
      type: 'GET',
      dataType: 'json',
...
function bersih(){
  ...
  $('input:text[name=tgl_perawatan]').val("2026-02-04");
  $('input:text[name=tgl_registrasi]').val("2026-02-04");
