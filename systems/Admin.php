...
class Admin extends Main
{
    ...
    public function drawTheme($file)
    {
		...
		$this->assign['module_operasi'] = $this->db('mlite_modules')->where('dir', 'operasi')->oneArray();
        $this->assign['operasi_access'] = ($access == 'all') || in_array('operasi', explode(',', $access)) ? true : false;
