...
$('#nmdpjplayanan').val(nmdpjplayanan);
            ...
            $('#modal-title').text("Edit Data BPJS SEP");
...
$('#nmdpjplayanan').val('');
        ...
        $('#modal-title').text("Tambah Data BPJS SEP");
        $("#modal_bridging_sep").modal();
    });
...
var no_sep = rowData['no_sep'];
            ...
            var loadURL =  baseURL + '/bpjs_sep/detail/' + no_sep + '?t=' + mlite.token;
