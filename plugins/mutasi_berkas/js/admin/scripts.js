jQuery().ready(function () {
    var var_tbl_mutasi_berkas = $('#tbl_mutasi_berkas').DataTable({
        ...
        "bInfo" : false,
        "ajax": {
            "url": "{?=url([ADMIN,'mutasi_berkas','data'])?}",
            "dataType": "json",
            "type": "POST",
            "data": function (data) {
...
var ranap= $('#ranap').val();
 ...
 formData.append('typeact', typeact); // tambahan
            ...
            $.ajax({
                url: "{?=url([ADMIN,'mutasi_berkas','aksi'])?}",
                method: "POST",
    ...
    // ==============================================================
    $('#search_text_mutasi_berkas').keyup(function () {
        var_tbl_mutasi_berkas.draw();
    });
    // ==============================================================
    // CLICK TANDA X DI INPUT SEARCH
    // ==============================================================
    $("#searchclear_mutasi_berkas").click(function () {
        $("#search_text_mutasi_berkas").val("");
        var_tbl_mutasi_berkas.draw();
    });
...
eTable += '<td>' + res[i]['ranap'] + '</td>';
        ...
        $("#modal_lihat_mutasi_berkas").modal();
    });

    // ==============================================================
    // TOMBOL DETAIL mutasi_berkas DI CLICK
    // ==============================================================
    jQuery("#lihat_detail_mutasi_berkas").click(function (event) {
...
var no_rawat = rowData['no_rawat'];
            ...
            var loadURL =  baseURL + '/mutasi_berkas/detail/' + no_rawat + '?t=' + mlite.token;
        
            var modal = $('#modal_detail_mutasi_berkas');
            var modalContent = $('#modal_detail_mutasi_berkas .modal-content');
