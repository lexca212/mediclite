...
$sep = $_POST['sep'];
            ...
            $mlite_antrian_referensi_add->execute([$tanggal_periksa, $no_rkm_medis, $nomor_kartu, $nomor_referensi, $kodebooking, $jenis_kunjungan, $status_kirim, $keterangan, $sep]);
...
$sep = $_POST['sep'];
        ...
        // BUANG FIELD PERTAMA
            ...
            $mlite_antrian_referensi_edit = $this->db()->pdo()->prepare("UPDATE mlite_antrian_referensi SET tanggal_periksa=?, no_rkm_medis=?, nomor_kartu=?, nomor_referensi=?, kodebooking=?, jenis_kunjungan=?, status_kirim=?, keterangan=?, sep=? WHERE tanggal_periksa=?");
            $mlite_antrian_referensi_edit->execute([$tanggal_periksa, $no_rkm_medis, $nomor_kartu, $nomor_referensi, $kodebooking, $jenis_kunjungan, $status_kirim, $keterangan, $sep,$tanggal_periksa]);
...
'sep'=>$row['sep']
    ...
    public function getCss()
    {
        ...
        echo $this->draw(MODULES.'/mlite_antrian_referensi/css/admin/styles.css');
        exit();
    }
    ...
    public function getJavascript()
    {
        ...
        echo $this->draw(MODULES.'/mlite_antrian_referensi/js/admin/scripts.js', ['settings' => $settings]);
        exit();
    }
    ...
    private function _addHeaderFiles()
    {
        ...
        $this->core->addCSS(url([ADMIN, 'mlite_antrian_referensi', 'css']));
        $this->core->addJS(url([ADMIN, 'mlite_antrian_referensi', 'javascript']), 'footer');
    }
