jQuery().ready(function () {
    var var_tbl_mlite_antrian_referensi = $('#tbl_mlite_antrian_referensi').DataTable({
        ...
        "bInfo" : false,
        "ajax": {
            "url": "{?=url([ADMIN,'mlite_antrian_referensi','data'])?}",
            "dataType": "json",
            "type": "POST",
            "data": function (data) {
...
var sep= $('#sep').val();
 ...
 formData.append('typeact', typeact); // tambahan
            ...
            $.ajax({
                url: "{?=url([ADMIN,'mlite_antrian_referensi','aksi'])?}",
                method: "POST",
...
$('#sep').val(sep);
            ...
            $('#modal-title').text("Edit Data mlite_antrian referensi");
...
$('#sep').val('');
        ...
        $('#modal-title').text("Tambah Data mlite_antrian referensi");
        $("#modal_mlite_antrian_referensi").modal();
    });
    ...
    $("#lihat_data_mlite_antrian_referensi").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                var eTable = "<div class='table-responsive'><table id='tbl_lihat_mlite_antrian_referensi' class='table display dataTable' style='width:100%'><thead><th>Tanggal Periksa</th><th>No Rkm Medis</th><th>Nomor Kartu</th><th>Nomor Referensi</th><th>Kodebooking</th><th>Jenis Kunjungan</th><th>Status Kirim</th><th>Keterangan</th><th>Sep</th></thead>";
...
var tanggal_periksa = rowData['tanggal_periksa'];
            ...
            var loadURL =  baseURL + '/mlite_antrian_referensi/detail/' + tanggal_periksa + '?t=' + mlite.token;
