...
'nmdpjplayanan'=>$row['nmdpjplayanan']
    ...
    public function getCss()
    {
        ...
        echo $this->draw(MODULES.'/data_sep/css/admin/styles.css');
        exit();
    }
    ...
    public function getJavascript()
    {
        ...
        echo $this->draw(MODULES.'/data_sep/js/admin/scripts.js', ['settings' => $settings]);
        exit();
    }
    ...
    private function _addHeaderFiles()
    {
        ...
        $this->core->addCSS(url([ADMIN, 'data_sep', 'css']));
        $this->core->addJS(url([ADMIN, 'data_sep', 'javascript']), 'footer');
    }
