    ...
    public function postOpnameUpdate()
    {
      ...
      for($count = 0; $count < count($kode_brng); $count++){
        ...
        if($selisih < 0) {
          $selisih = 0;
          $nomihilang = 0;
          $lebih = $real[$count] - $stok[$count];
          $nomilebih = $lebih * $h_beli[$count];
        }

        $query2 = "INSERT INTO `opname` (`kode_brng`, `h_beli`, `tanggal`, `stok`, `real`, `selisih`, `nomihilang`, `lebih`, `nomilebih`, `keterangan`, `kd_bangsal`, `no_batch`, `no_faktur`) VALUES ('$kode_brng[$count]', '$h_beli[$count]', '$tanggal[$count]', '$stok[$count]', '$real[$count]', '$selisih', '$nomihilang', '$lebih', '$nomilebih', '$keterangan[$count]', '$kd_bangsal[$count]', '$no_batch[$count]', '$no_faktur[$count]')";
