jQuery().ready(function () {
    var var_tbl_pemeriksaan_ralan = $('#tbl_pemeriksaan_ralan').DataTable({
        ...
        "bInfo" : false,
        "ajax": {
            "url": "{?=url([ADMIN,'pemeriksaan_ralan','data'])?}",
            "dataType": "json",
            "type": "POST",
            "data": function (data) {
                ...
                data.search_field_pemeriksaan_ralan = search_field_pemeriksaan_ralan;
                data.search_text_pemeriksaan_ralan = search_text_pemeriksaan_ralan;
...
jam_rawat:'jam_rawat tidak boleh kosong!',
suhu_tubuh:'suhu_tubuh tidak boleh kosong!',
...
var nip= $('#nip').val();
 ...
 formData.append('typeact', typeact); // tambahan
            ...
            $.ajax({
                url: "{?=url([ADMIN,'pemeriksaan_ralan','aksi'])?}",
                method: "POST",
    ...
    // ==============================================================
    $('#search_text_pemeriksaan_ralan').keyup(function () {
        var_tbl_pemeriksaan_ralan.draw();
    });
    // ==============================================================
    // CLICK TANDA X DI INPUT SEARCH
    // ==============================================================
    $("#searchclear_pemeriksaan_ralan").click(function () {
        $("#search_text_pemeriksaan_ralan").val("");
        var_tbl_pemeriksaan_ralan.draw();
    });
...
eTable += '<td>' + res[i]['nip'] + '</td>';
        ...
        $("#modal_lihat_pemeriksaan_ralan").modal();
    });

    // ==============================================================
    // TOMBOL DETAIL pemeriksaan_ralan DI CLICK
    // ==============================================================
    jQuery("#lihat_detail_pemeriksaan_ralan").click(function (event) {
...
var no_rawat = rowData['no_rawat'];
            ...
            var loadURL =  baseURL + '/pemeriksaan_ralan/detail/' + no_rawat + '?t=' + mlite.token;
